...
const Music = () => {
  ...
  const test = `<iframe width="100%" height="300" scrolling="no" frameborder="no" allow="autoplay" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/1039025494&color=%23a4a4a4&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe><div style="font-size: 10px; color: #cccccc;line-break: anywhere;word-break: normal;overflow: hidden;white-space: nowrap;text-overflow: ellipsis; font-family: Interstate,Lucida Grande,Lucida Sans Unicode,Lucida Sans,Garuda,Verdana,Tahoma,sans-serif;font-weight: 100;"><a href="https://soundcloud.com/douvelle19" title="DOUVELLE19" target="_blank" style="color: #cccccc; text-decoration: none;">DOUVELLE19</a> · <a href="https://soundcloud.com/douvelle19/sets/edits-vol2" title="edits vol.2" target="_blank" style="color: #cccccc; text-decoration: none;">edits vol.2</a></div>`;

  const test2 = `<iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/0yBUPNDd4cXVZ41C5BPS6d?utm_source=generator" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>`;
  ...
  return (
    <div className={classes.music}>
      <div className={classes.musicSpotifyWrapper}>
        <div className={classes.musicSpotify}>
          <InnerHTML html={test2} />
        </div>
      </div>

      <div className={classes.musicSoundcloudWrapper}>
        <div className={classes.musicSoundcloud}>
